/**************************************************************
    ...
    Bob Stout made minor changes to get rid of some compiler warnings
      in early 1993.
        
    This program goes into a loop on 32-bit machines, e.g. MVS and
      OS/2.  The problem goes away on 32-bit machines if you change
      all ints to shorts and all unsigned to unsigned short, and
      unsigned int to unsigned short.  Naturally this *kludge* will
      not help for 36-bit machines with 18-bit shorts, so we need 
      someone to figure out where to put an "& 0xffff".
**************************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
